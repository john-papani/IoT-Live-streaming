package com.java.infosystem.examples;
...
import com.java.infosystem.examples.Word;
...
public class KeyByExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Flink 1.11开始废弃了这个方法
        DataStream<Tuple2<Integer, Double>> keyedStream = dataStream.keyBy(value -> value.f0).sum(1);
        keyedStream.print();
        ...
        // 使用字段名
        // Flink 1.11开始废弃了这个方法
        DataStream<Word> fieldNameStream = wordStream.keyBy(value -> value.word).sum("count");
